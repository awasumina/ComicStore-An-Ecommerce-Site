			  ...
			  <tr>
				...
				>
				  <a
					...
					style='line-height: 21px;text-align: center; text-decoration: none; margin: 0px; display:block;
					...
					'
				  >
					<span style="text-align: center;vertical-align: middle;<?php echo esc_attr( 'line-height: ' . $attrs['heightButton'] ) . 'px'; ?>;<?php echo esc_attr( 'color: ' . $attrs['textColor'] ); ?>;"><?php echo wp_kses_post( $attrs['text'] ); ?></span>
				  </a>
				</td>
			  </tr>
			</tbody>
